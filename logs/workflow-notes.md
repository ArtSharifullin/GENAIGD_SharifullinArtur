...
Проблема: босс-кадр тесный для презентационного использования в слайде.  
Прием: outpaint вправо и вверх с удержанием палитры и световых акцентов.  
Результат:
- Появился дополнительный воздух вокруг босса.
- Сохранен силуэт героя внизу и доминанта Луны.
- Местами заметен шов освещения, требует еще одной аккуратной итерации.

### Итоговый вывод
- `img2img` лучше всего решает глобальную чистку кадра.
- `inpaint` нужен для точечных исправлений без срыва общего стиля.
- `outpaint` полезен как подготовка к финальным скриншотам, но требует контроля света и перспективы.
- Следующий шаг: подключить ControlNet (`pose`, `depth`, `canny`) для стабилизации формы и композиции.